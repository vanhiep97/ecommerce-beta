                                            ...
                                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                <div class="tab-pane fade active show" id="custom-nav-home" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <select name="type_pro_id" id="type_pro_id" class="form-control">
                                                                <option value="{{ $product->type_product_id }}">Chọn loại sản phẩm</option>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="pro_code" name="pro_code" value="{!! old('pro_code', $product->pro_code) !!}" placeholder="Mã sản phẩm"
                                                                   class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="pro_name" name="pro_name" value="{!! old('pro_name', $product->pro_name) !!}"
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" name="pro_slug" value="{!! old('pro_slug', $product->pro_slug) !!}" id="pro_slug" disabled
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="prd_price" name="prd_price" value="{!! old('prd_price', $product_details['prd_price']) !!}"
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="number" id="prd_percent_discount" name="prd_percent_discount" value="{!! old('prd_price', $product_details['prd_percent_discount']) !!}"
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <textarea name="prd_excerpt" id="prd_excerpt" rows="5" placeholder="Mô tả ngắn" class="form-control">{!! $product_details['prd_excerpt'] !!}" !!}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
